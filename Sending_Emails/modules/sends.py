...
#get_template import is imported into send.py with two args school, sport

#this is then passed into send function

#send function is then passed into process 

#process is then called within the blast function



#Ultimately needs to be accepted into the configuration
